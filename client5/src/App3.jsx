            ...
            <aside className="md:col-span-1 space-y-6">
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  ...
                  real-world applications using modern web technologies. Always
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">
                      Built using Express.js & MongoDB with full CRUD
                      functionality.
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">
                      Designed schemas for users, restaurants, riders, and
                      orders with complete order flow.
                    </p>
                  </div>
                </div>
              </section>
